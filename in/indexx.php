...
<body>
      ...
      <div class="slider-container">
        <div class="slider-text">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slider-text__slide">
              <h1> STAYING LOCAL <br> <span> WORKING GLOBAL </span></h1>
              <p> Who would not like to stand tall and proud? </p>
        ...
        <div class="slider-img">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slider-img__slide">
              <div class="slider-img__bg" style="background-image: url(./img/hero-2.png);" data-swiper-parallax="20%">
              </div>
            </div>
        ...
        <!-- <div class="slider-pagination-current">01</div> -->
  ...
  <section class="portfolio-area">
    ...
    <div class="row portfolio-boxes">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
        <div class="box">
          <img src="./img/services/web/kistler.jpg" alt="portfolio">
          <div class="box-content">
            <h3 class="title"> Kistler GmbH </h3>
            <span class="post"> Website </span>
          </div>
          <ul class="icon">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
        <div class="box">
          <img src="./img/services/digatal/kistler-app-poster-change.jpg" alt="portfolio">
          <div class="box-content">
            <h3 class="title">kistler GmbH</h3>
            <span class="post"> Sales App </span>
          </div>
          <ul class="icon">
            <li><a href="portfolio.php"><i class="fa fa-link"></i></a></li>
          </ul>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
        <div class="box">
          <img src="./img/services/branding/promag.jpg" alt="portfolio">
          <div class="box-content">
            <h3 class="title">Promag</h3>
            <span class="post"> Brochure Design </span>
          </div>
          <ul class="icon">
            <li><a href="portfolio.php"><i class="fa fa-link"></i></a></li>
          </ul>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
        <div class="box">
          <img src="./img/auto-tech.jpg" alt="portfolio">
          <div class="box-content">
            <h3 class="title">Autotech</h3>
            <span class="post"> Broucher </span>
          </div>
          <ul class="icon">
            <li><a href="portfolio.php"><i class="fa fa-link"></i></a></li>
          </ul>
        ...
        <div class="row services-home">
          ...
          <ul>
            <li>
              ...
              <h2> <a href="photography-and-video-production.php"> Photography & <br> Video Production </a> </h2>
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      ...
                      <div class="team-content">
                        <h3 class="title"> Kavya V Sagar </h3>
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      <div class="pic">
                        <img src="./img/team/dhanya.jpg" alt="Dhanya">
                        <ul class="social-links">
                          <li><a href="#" class="fab fa-linkedin"></a></li>
                          <li><a href="#" class="fab fa-facebook"></a></li>
                          <li><a href="#" class="fab fa-instagram"></a></li>
                      ...
                      <div class="team-content">
                        <h3 class="title"> Dhanya P Nair </h3>
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      <div class="pic">
                        <img src="./img/team/nivethitha.jpg" alt="nivethitha">
                        <ul class="social-links">
                          <li><a href="#" class="fab fa-linkedin"></a></li>
                          <li><a href="#" class="fab fa-facebook"></a></li>
                          <li><a href="#" class="fab fa-instagram"></a></li>
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      <div class="pic">
                        <img src="./img/team/Robin.jpg" alt="Robin">
                        <ul class="social-links">
                          <li><a href="#" class="fab fa-linkedin"></a></li>
                          <li><a href="#" class="fab fa-facebook"></a></li>
                          <li><a href="#" class="fab fa-instagram"></a></li>
                      ...
                      <div class="team-content">
                        <h3 class="title"> Robin George </h3>
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      <div class="pic">
                        <img src="./img/team/Anwar.jpg" alt="Anwar">
                        <ul class="social-links">
                          <li><a href="#" class="fab fa-linkedin"></a></li>
                          <li><a href="#" class="fab fa-facebook"></a></li>
                          <li><a href="#" class="fab fa-instagram"></a></li>
                      ...
                      <div class="team-content">
                        <h3 class="title"> Muhammad Anwar </h3>
                  ...
                  <div class="swiper-slide">
                    <div class="our-team">
                      ...
                      <div class="team-content">
                        ...
                        <span class="post"> Ul UX Designer </span>
                      </div>
                    </div>
                  </div>
                  <!-- slide -->
  ...
  <section class="customer-logos slider">
    ...
    <div class="slide">
      <img src="./img/clients/mkm-logo.png" alt="clients">
    </div>
    <div class="slide">
            ...
            <div class="swiper bloghomeSwiper">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="row">
                    ...
                    <div class="col-xl-7 bloghomeSwiper-details">
                      ...
                      <p>An increasingly important component of marketers' evolving digital strategies are animation videos. Really though, what's the big deal?
                ...
                <div class="swiper-slide">
                  <div class="row">
                    <div class="col-xl-5 bloghomeSwiper-pic">
                      <img src="./img/blogs/How-Does-Branding-Contribute-to-Effective-Business-Strategy-Implementation.jpg" alt="How Does Branding Contribute to Effective Business Strategy Implementation">
                    </div>
                    <div class="col-xl-7 bloghomeSwiper-details">
                      <h2> How Does Branding Contribute to Effective Business Strategy Implementation? </h2>
                      <p> In today's fast-paced and highly competitive business environment, the role of branding in business has become increasingly crucial.
                        A well-crafted brand not only distinguishes a company from its competitors but also plays a significant role in the successful
                ...
                <div class="swiper-slide">
                  <div class="row">
                    <div class="col-xl-5 bloghomeSwiper-pic">
                      <img src="./img/blogs/The-Future-Of-Text-Sharing-Twiter-Or-Instagram-Tread-Who-Will-Survive-The-Battle.jpg" alt="The Future of Text Sharing: Twitter or Instagram Thread - Who Will Survive the Battle?">
                    </div>
                    <div class="col-xl-7 bloghomeSwiper-details">
                      <h2> The Future of Text Sharing: Twitter or Instagram Thread - Who Will Survive the Battle? </h2>
                      <p> In an era where social media platforms have become integral parts of our daily lives, the battle for dominance
                        in the realm of text sharing is heating up between two major contenders: Twitter and Instagram. Both platforms
                        have their unique features and strengths, but which one will emerge victorious in the long run? In this blog,
                        we will delve into the future of text sharing, examining the key attributes of Twitter and Instagram Threads,
